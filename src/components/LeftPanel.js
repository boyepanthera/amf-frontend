...
export const LeftPanel  = ()=>{
  ...
  return (
    <div>
      <div className='p-10 text-purple-800 font-extrabold text-3xl'>Parser</div>
      ...
      <div className='justify-center flex'>
          <div className='item-1 text-3xl text-center font-bold text-purple-900'>In One Click.</div>
      </div>
