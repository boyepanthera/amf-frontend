    ...
    return (
        <nav className='flex justify-between items-center flex-wrap p-4 px-12 bg-orange-500'>
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto  ml-auto">
                ...
                <div>
                    <Link to='/dashboard' class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-orange-500 hover:bg-white mt-4 lg:mt-0">Dashboard</Link>
                </div>
            </div>
        </nav>
    )
